...
> Assignment submission format: a single ipynb file `03-data-models.ipynb`, as describe in step 4.
> 
...
4. Follow instructions from file `/app/hostdir/03-data-models.ipynb`
   (container's path).
