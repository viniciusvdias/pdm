...
> Assignment submission format: a single ipynb file `04-batch-rdd.ipynb`, as describe in step 4.
> 
...
4. Follow instructions from file `/app/hostdir/04-batch-rdd.ipynb`
   (container's path).
