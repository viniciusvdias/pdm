...
> Assignment submission format: a single ipynb file `09-stream-structured-streaming-kafka.ipynb`, as describe in step 4.
> 
...
4. Follow instructions from file `/app/hostdir/09-stream-structured-streaming-kafka.ipynb`
   (container's path).
