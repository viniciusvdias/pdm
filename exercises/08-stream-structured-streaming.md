...
> Assignment submission format: a single ipynb file `08-stream-structured-streaming.ipynb`, as describe in step 4.
> 
...
4. Follow instructions from file `/app/hostdir/08-stream-structured-streaming.ipynb`
   (container's path).
