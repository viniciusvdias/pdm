...
> Assignment submission format: a single ipynb file `07-struct-sparksql-api.ipynb`, as describe in step 4.
> 
...
4. Follow instructions from file `/app/hostdir/07-struct-sparksql-api.ipynb`
   (container's path).
