...
> Assignment submission format: a single ipynb file `02-sys-processes-performance.ipynb`, as describe in step 4.
> 
...
4. Follow instructions from file `/app/hostdir/02-sys-processes-performance.ipynb`
   (container's path).
